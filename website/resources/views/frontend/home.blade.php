...
<!-- <div class="cy_about_wrapper">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 col-md-12">
                    <div>
                        Get Our App in Store
                    </div>
                    <p>Download Our App Here</p>
                    <div class="">
                        <span><h1>Get Our From PlayStore</h1></span>
                        <span><img src="public/theme/images/google_play.png" alt=""></span>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12">
                    <div class="cy_price_box">
                        <a href="#"><img src="public/theme/images/image_app_sample.png" style="width:100%;"></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!--Team section start-->
    <div class="cy_team_wrapper" style="display:none;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
